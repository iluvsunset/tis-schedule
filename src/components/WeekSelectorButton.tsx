  ...
  return (
    <div className={`relative inline-block no-print ${isOpen ? 'z-50' : 'z-30'}`} ref={dropdownRef}>
      <motion.button
        ...
        className="px-2.5 py-1 rounded-xl text-xs font-bold bg-slate-100/90 dark:bg-slate-800/90 hover:bg-slate-200/90 dark:hover:bg-slate-700/90 border border-slate-200/80 dark:border-slate-700/80 text-slate-700 dark:text-slate-200 transition-all flex items-center gap-1.5 cursor-pointer shadow-2xs"
